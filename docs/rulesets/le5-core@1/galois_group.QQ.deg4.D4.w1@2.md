# Rule: `galois_group.QQ.deg4.D4.w1@2`
...
These are the same premises as in `galois_group.QQ.deg4.D4.w1@1`, except that the resolvent family required in the `ResolventQQ` premise is now the pair-sums family
...
This rule certifies the dihedral case by requiring `NonSquareQQ(w1)`. Since at least one auxiliary value fails the square test, the cyclic case is excluded.
...
13. Recompute
    ...
    w_2=((b-s_0)^2-4d)\Delta.
    \]
14. Require the `NonSquareQQ` premise to bind to the exact `RatQQ` object encoding `w1`.
...
Files:
- OK:
  - `fixtures/v3/le5-core@1/ok/galois_group.QQ.deg4.D4.w1@2_001.json`
- BAD:
  - `fixtures/v3/le5-core@1/bad/galois_group.QQ.deg4.D4.w1@2_fail_001.json`
