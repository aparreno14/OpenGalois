# Rule: `galois_group.QQ.deg4.D4.w2@1`
...
13. Recompute
    ...
    w_2=(r_0^2-4d)\Delta.
    \]
14. Check there is a verified premise `NonSquareQQ(u2)` whose argument is exactly the `RatQQ`
    object encoding `w2`.
...
## 8) Fixtures
- OK:
  - `fixtures/v3/le5-core@1/ok/galois_group.QQ.deg4.D4.w2@1_001.json`
- BAD:
  - `fixtures/v3/le5-core@1/bad/galois_group.QQ.deg4.D4.w2@1_fail_001.json`
  - `fixtures/v3/le5-core@1/bad/galois_group.QQ.deg4.D4.w2@1_fail_002.json`
