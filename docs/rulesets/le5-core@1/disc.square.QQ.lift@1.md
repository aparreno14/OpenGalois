...
- `IsSquareQQ(D)` for the same `D` appearing in the discriminant premise.
...
3. Check there exists a verified premise `IsSquareQQ(D)` for the same `D` reference.
4. Accept.
...
## 7) Fixtures
- OK: `fixtures/v3/le5-core@1/ok/disc.square.QQ.lift@1_001.json`
- BAD: `fixtures/v3/le5-core@1/bad/disc.square.QQ.lift@1_fail_001.json`
